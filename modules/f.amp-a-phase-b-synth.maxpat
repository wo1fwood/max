...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 208.0, 156.0, 47.0 ],
					"style" : "",
					"text" : "using the amp of source-1 and phase of source-2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 48.0, 112.0, 87.0, 22.0 ],
					"style" : "",
					"text" : "cartopol~"
				}
